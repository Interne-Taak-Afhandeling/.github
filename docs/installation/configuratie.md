...
| web.oidc.functioneelBeheerderRole                       | De waarde van de role claim in het JWT token van de OpenID Connect Provider voor toegang tot beheer functies (zoals het beheren van kanalen) <details> <summary>Meer informatie </summary>Bijvoorbeeld: `ITA-Functioneel-Beheerder` </details>     |
