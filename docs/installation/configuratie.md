...
| web.oidc.objectregisterMedewerkerIdClaimType            | De naam van de claim in het JWT token van de OpenID Connect Provider waarin een unieke identificatie van de ingelogde gebruiker staat die overeenkomt met het id van de medewerker in het medewerker register (OverigeObjecten). Nb. in combinatie met KISS moet deze claim het emailadres van de gebruiker bevaten. <br/>    |
